...
public class YamlReadUtil {
    public static void main(String args[]) throws FileNotFoundException, YamlException {
        String path="src/main/java/org/webdriver/mindaiappui/pageObjectConfig/demo.yaml";
        String path2="src/main/java/org/webdriver/mindaiappui/pageObjectConfig/UiLibrary.yaml";
        File file=new File("src/main/java/org/webdriver/mindaiappui/pageObjectConfig/UiLibrary.yaml");
        YamlReadUtil yamlReadUtil=new YamlReadUtil();
        yamlReadUtil.getLocatorMap(path2,"org.webdriver.mindaiappui.pageObject.StartPage");
        yamlReadUtil.getYamlPageUrl(path2,"org.webdriver.mindaiappui.pageObject.StartPage");
    }
