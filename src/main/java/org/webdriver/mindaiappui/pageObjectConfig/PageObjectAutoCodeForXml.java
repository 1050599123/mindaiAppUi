...
public class PageObjectAutoCodeForXml {
	...
	static  String path="src/main/java/org/webdriver/mindaiappui/pageObjectConfig/UILibrary.xml";
	public static void autoCode() throws Exception
	{
		...
		for(Iterator<?> i=root.elementIterator();i.hasNext();)
		{
			...
			sb.append("import org.webdriver.mindaiappui.pageObjectConfig.PageObjectAutoCodeForXml;");
