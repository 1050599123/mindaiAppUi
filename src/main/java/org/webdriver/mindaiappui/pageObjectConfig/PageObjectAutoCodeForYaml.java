package org.webdriver.mindaiappui.pageObjectConfig;
...
public class PageObjectAutoCodeForYaml {
	...
	static  String path="src/main/java/org/webdriver/mindaiappui/pageObjectConfig/UILibrary.yaml";
	public static void autoCode() throws Exception
	{
		...
		for (int i=0;i<pages.size();i++)
		{
			...
			sb.append("import org.webdriver.mindaiappui.utils.BaseAction;\n");
			sb.append("import org.webdriver.mindaiappui.utils.Locator;\n");
			sb.append("import org.webdriver.mindaiappui.pageObjectConfig.PageObjectAutoCodeForYaml;");
			...
			sb.append("private String path=\"src/main/java/org/webdriver/mindaiappui/pageObjectConfig/UILibrary.yaml\";\n");
			sb.append(" public   "
					+ pageClassName
					+ "() {\n");
			...
			File pageObjectFile=new File("src/main/java/org/webdriver/mindaiappui/pageObject/"+pageClassName+".java");
	...
	public static void autoCode2() throws Exception
	{
		...
		for(Iterator<?> i=root.elementIterator();i.hasNext();)
		{
			...
			sb.append("import org.webdriver.mindaiappui.utils.BaseAction;\n");
			sb.append("import org.webdriver.mindaiappui.utils.Locator;\n");
			sb.append("import org.webdriver.mindaiappui.pageObjectConfig.PageObjectAutoCode;");
			sb.append("//"+page.attribute(2).getValue()+"_对象库类\n");
			sb.append("public class "+ pageClassName+" extends BaseAction {\n");
			sb.append("//用于eclipse工程内运行查找对象库文件路径\n");
			sb.append("private String path=\"src/main/java/org/webdriver/mindaiappui/pageObjectConfig/UILibrary.xml\";\n");
